          ...
          <Card className="shadow-2xl border-2">
            ...
            <CardContent className="space-y-6">
              ...
              <SecretView
                ...
                message="You've successfully accessed Secret Page 2. This is a protected area only visible to authenticated users. The secret of the universe is... patience and persistence!"
              />
